...
public class OkImageLoader {
     ...
     * @return
     */
    public static OkImageLoader build(String baseUrl) {
        return new OkImageLoader(baseUrl);
    }

    private OkImageLoader(String baseUrl) {
        mBean=new ImageBean();
        mBean.url=baseUrl;
        mIsDragging=true;
        initHandler();
...
//        mBean.url=url;
    ...
    public Bitmap loadImage(final Context context) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                Bitmap bitmap=null;
                try {
                    bitmap = BitmapUtils.getBitmap(response.body().bytes(), mBean.width, mBean.height);
                } catch (Exception e) {
     ...
     * @return
     */
    public OkImageLoader defaultPicture(int defaultPicId) {
     ...
     * @return
     */
    public OkImageLoader setDragging(boolean isDragging) {
